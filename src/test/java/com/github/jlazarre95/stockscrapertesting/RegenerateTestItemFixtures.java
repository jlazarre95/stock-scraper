...
import com.github.jlazarre95.stockscraper.services.WebScraper;
...
public class RegenerateTestItemFixtures {
    ...
    public void scrapeInStockWalmartItem() throws IOException {
        String text = this.webScraper.scrape("https://www.walmart.com/ip/Marvel-s-Spider-Man-Miles-Morales-Ultimate-Launch-Edition-Sony-PlayStation-5/795159051");
    ...
    public void scrapeOutOfStockWalmartItem() throws IOException {
        String text = this.webScraper.scrape("https://www.walmart.com/ip/PlayStation-5-Console/363472942");
    ...
    public void scrapeInStockBestBuyItem() throws IOException {
        String text = this.webScraper.scrape("https://www.bestbuy.com/site/searchpage.jsp?st=monitor&_dyncharset=UTF-8&_dynSessConf=&id=pcat17071&type=page&sc=Global&cp=1&nrp=&sp=&qp=&list=n&af=true&iht=y&usc=All+Categories&ks=960&keys=keys");
    ...
    public void scrapeOutOfStockBestBuyItem() throws IOException {
        String text = this.webScraper.scrape("https://www.bestbuy.com/site/searchpage.jsp?st=rtx+3080&_dyncharset=UTF-8&_dynSessConf=&id=pcat17071&type=page&sc=Global&cp=1&nrp=&sp=&qp=&list=n&af=true&iht=y&usc=All+Categories&ks=960&keys=keys");
    ...
    public void scrapeInStockNeweggItem() throws IOException {
        String text = this.webScraper.scrape("https://www.newegg.com/p/pl?d=monitor");
    ...
    public void scrapeOutOfStockNeweggItem() throws IOException {
        String text = this.webScraper.scrape("https://www.newegg.com/p/pl?d=rtx+3080+combo");
